...
class GainersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_gainers, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        retrofitData.enqueue(object : Callback<List<CoinPriceItem>?> {
            override fun onResponse(
                ...
                val responseBody = response?.body()?.sortedByDescending { coinPriceItem -> coinPriceItem.price_change_percentage_24h }!!
                ...
                recycleView = view.findViewById(R.id.rv_recyclerView_gainer)
